...
ISTORE_FEED="src-git istore https://github.com/linkease/istore.git^6f795b7640390ab28a2f1aaa14b33292aa5f2128"
...
grep -Fq 'config PACKAGE_luci-compat' "$OPENCLASH_DST/Makefile"
